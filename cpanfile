...
requires 'Catalyst::Model::HTMLFormhandler', '0.006';
...
requires 'Catalyst::TraitFor::Request::ContentNegotiationHelpers', '0.004';
requires 'Catalyst::TraitFor::Request::QueryFromJSONY', '0.002';
requires 'Catalyst::View::JSON::PerRequest', '0.004';
requires 'Catalyst::View::Text::MicroTemplate::PerRequest', '0.001';
